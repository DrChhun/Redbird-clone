    ...
    return (
        <>
            ...
            <div className="py-12 px-10 bg-[#ed1c24] text-white">
                <div className="md:grid md:grid-cols-3">
                    <div className="text-center md:text-left mb-8 md:mb-0">
                        <h2 className="text-xs md:text-lg font-bold">ស្វែងយល់អំពីពួកយើង</h2>
                    ...
                    <div className="text-center mb-8 md:mb-0">
                        <h2 className="text-xs font-bold md:text-lg mb-4">អត្ថបទផ្សេងៗ</h2>
                    ...
                    <div className="text-center md:text-right">
                        <h2 className="text-xs font-bold md:text-lg">ទំនាក់ទំនងពួកយើង</h2>
            ...
            <div className="text-center md:flex md:justify-between py-6 px-10 font-light">
                <h2 className="text-xs md:text-base">@2022 Baksey Media All Right Reserved</h2>
