...
const NewsCard: React.FC<News> = ({ image, title, tag, profile }) => (
  <>
    ...
    <div className="flex justify-between flex-col bg-white shadow-xl rounded-xl hover:shadow-lg duration-300 hover:cursor-pointer overflow-hidden group h-full">
      <div>
        <Image
          loader={loader}
        ...
        />
          ...
          <h1 className="p-4 font-bold text-base text-gray-600 hover:underline">
